...
export const ALL_CRYSTALS_REQUEST = "ALL_CRYSTALS_REQUEST";
export const ALL_CRYSTALS_SUCCESS = "ALL_CRYSTALS_SUCCESS";
export const ALL_CRYSTALS_FAIL = "ALL_CRYSTALS_FAIL";

export const ALL_BRACELETS_REQUEST = "ALL_BRACELETS_REQUEST";
export const ALL_BRACELETS_SUCCESS = "ALL_BRACELETS_SUCCESS";
export const ALL_BRACELETS_FAIL = "ALL_BRACELETS_FAIL";

export const ALL_MALAS_REQUEST = "ALL_MALAS_REQUEST";
export const ALL_MALAS_SUCCESS = "ALL_MALAS_SUCCESS";
export const ALL_MALAS_FAIL = "ALL_MALAS_FAIL";

export const ALL_PRODUCTS_LISTS_REQUEST = "ALL_PRODUCTS_LISTS_REQUEST";
export const ALL_PRODUCTS_LISTS_SUCCESS = "ALL_PRODUCTS_LISTS_SUCCESS";
export const ALL_PRODUCTS_LISTS_FAIL = "ALL_PRODUCTS_LISTS_FAIL";
