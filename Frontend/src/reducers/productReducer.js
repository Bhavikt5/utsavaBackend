import {
  ...
  ALL_PRODUCT_REQUEST,
  ALL_PRODUCT_SUCCESS,
  ALL_CRYSTALS_REQUEST,
  ALL_CRYSTALS_SUCCESS,
  ALL_CRYSTALS_FAIL,
...
export const productsListReducer = (
  ...
  switch (action.type) {
    case ALL_PRODUCTS_LISTS_REQUEST:
      return {
        loading: true,
        totalProductsList: [],
      };

    case ALL_PRODUCTS_LISTS_SUCCESS:
      return {
        loading: false,
...
export const productsByCategoryReducer = (state = { products: [] }, action) => {
  switch (action.type) {
    case ALL_CRYSTALS_REQUEST:
      return {
        loading: true,
        products: [],
      };

    case ALL_CRYSTALS_SUCCESS:
      return {
        loading: false,
